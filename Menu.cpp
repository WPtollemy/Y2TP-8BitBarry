...
void Menu::draw(sf::RenderWindow &window)
{
    ...
    //Game::draw_text(window, "C R E D I T    0 0", (Globals::SCREEN_WIDTH / 2) - 100, 627); 
    
    this->drawLine(window, "P L A Y", (Globals::SCREEN_WIDTH / 2) - 55, 180, this->PAUSE, 1);
	...
	*/
    Game::draw_text(window, "P R E S S                        T O    P L A Y", (Globals::SCREEN_WIDTH / 2) - 200, 450);
    Game::draw_text(window, "E N T E R", (Globals::SCREEN_WIDTH / 2) - 70, 450); //, sf::Color::Green
}
