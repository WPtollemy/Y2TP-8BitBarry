...
NormalInvaderLaser::NormalInvaderLaser(const unsigned x, const unsigned y, const unsigned barrier_line, const bool will_hurt, Invader &owner): InvaderLaser(LaserType::NORMAL, 5, 15, barrier_line, will_hurt, owner), h_part_movedir(1)
{
...
void NormalInvaderLaser::move()
{
    ...
    // Change color to green once past the barriers.
