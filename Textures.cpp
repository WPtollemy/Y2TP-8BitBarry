...
Textures::Textures()
{
    this->spritesheet = this->loadSprites(Globals::SPRITES_PATH + "invader_sprites2.png");

    sf::IntRect UFO_RECT(382, 12, 86, 58);
    ...
    sf::IntRect COREplayer_RECT(492, 25, 48, 47);
    sf::IntRect COREplayer_DEATH_1_RECT(421, 104, 54, 29);
    sf::IntRect COREplayer_DEATH_2_RECT(485, 104, 55, 29);
    this->COREplayer.loadFromImage(this->spritesheet, COREplayer_RECT);
    this->COREplayer_DEATH_1.loadFromImage(this->spritesheet, COREplayer_DEATH_1_RECT);
    this->COREplayer_DEATH_2.loadFromImage(this->spritesheet, COREplayer_DEATH_2_RECT);
